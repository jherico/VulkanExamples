...
#include <shaders/stencilbuffer/outline.frag.inl>
#include <shaders/stencilbuffer/outline.vert.inl>
#include <shaders/stencilbuffer/toon.frag.inl>
#include <shaders/stencilbuffer/toon.vert.inl>
...
public:
    ...
    void loadAssets() override { model.loadFromFile(getAssetPath() + "models/venus.fbx", vertexLayout, 0.3f); }
    ...
    void preparePipelines() {
        ...
        // The shaders don't use the color input
        builder.vertexInputState.erase(1);

        // Toon render and stencil fill pass
        builder.loadShader(vkx::shaders::stencilbuffer::toon::vert, vk::ShaderStageFlagBits::eVertex);
        builder.loadShader(vkx::shaders::stencilbuffer::toon::frag, vk::ShaderStageFlagBits::eFragment);
        ...
        builder.loadShader(vkx::shaders::stencilbuffer::outline::vert, vk::ShaderStageFlagBits::eVertex);
        builder.loadShader(vkx::shaders::stencilbuffer::outline::frag, vk::ShaderStageFlagBits::eFragment);
