...
#include <shaders/specializationconstants/uber.frag.inl>
#include <shaders/specializationconstants/uber.vert.inl>
...
public:
    ...
    void loadAssets() override {
        models.cube.loadFromFile(getAssetPath() + "models/color_teapot_spheres.dae", vertexLayout, 0.1f);
        textures.colormap.loadFromFile(getAssetPath() + "textures/metalplate_nomips_rgba.ktx", vk::Format::eR8G8B8A8Unorm);
    }
    ...
    void preparePipelines() {
        ...
        builder.loadShader(vkx::shaders::specializationconstants::uber::vert, vk::ShaderStageFlagBits::eVertex);
        builder.loadShader(vkx::shaders::specializationconstants::uber::frag, vk::ShaderStageFlagBits::eFragment);
