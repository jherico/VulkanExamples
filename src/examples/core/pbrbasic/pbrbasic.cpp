...
#include <shaders/pbrbasic/pbr.frag.inl>
#include <shaders/pbrbasic/pbr.vert.inl>
...
public:
    ...
    void preparePipelines() {
        ...
        pipelineBuilder.loadShader(vkx::shaders::pbrbasic::pbr::vert, vSS::eVertex);
        pipelineBuilder.loadShader(vkx::shaders::pbrbasic::pbr::frag, vSS::eFragment);
