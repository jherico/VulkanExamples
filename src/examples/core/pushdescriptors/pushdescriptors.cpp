...
#include <shaders/pushdescriptors/cube.frag.inl>
#include <shaders/pushdescriptors/cube.vert.inl>
...
public:
    ...
    void updateDrawCommandBuffer(const vk::CommandBuffer& drawCmdBuffer) override {
        ...
        for (const auto& cube : cubes) {
            ...
            vk::DescriptorImageInfo cubeTexture{ defaultSampler, cube.texture.imageView, vk::ImageLayout::eReadOnlyOptimal };
            ...
            // Texture
            writeDescriptorSets.push_back({ nullptr, 2, 0, 1, vk::DescriptorType::eCombinedImageSampler, &cubeTexture });

            drawCmdBuffer.pushDescriptorSetKHR(vk::PipelineBindPoint::eGraphics, pipelineLayout, 0, writeDescriptorSets);
            drawCmdBuffer.drawIndexed(models.cube.indexCount, 1, 0, 0, 0);
        }
    }

    void loadAssets() override {
        models.cube.loadFromFile(getAssetPath() + "models/cube.dae", vertexLayout);
    ...
    void setupDescriptorSetLayout() {
        ...
        descriptorSetLayout = device.createDescriptorSetLayout(
            { vk::DescriptorSetLayoutCreateFlagBits::ePushDescriptorKHR, static_cast<uint32_t>(setLayoutBindings.size()), setLayoutBindings.data() });
    ...
    void preparePipelines() {
        ...
        auto builder = vks::pipelines::GraphicsPipelineBuilder(device, pipelineLayout);
        ...
        builder.loadShader(vkx::shaders::pushdescriptors::cube::vert, vk::ShaderStageFlagBits::eVertex);
        builder.loadShader(vkx::shaders::pushdescriptors::cube::frag, vk::ShaderStageFlagBits::eFragment);
    ...
    void prepareUniformBuffers() {
        ...
        for (auto& cube : cubes) {
            cube.uniformBuffer = loader.createUniformBuffer(cube.modelMat);
        }
    ...
    void updateCubeUniformBuffers() {
        ...
        for (auto& cube : cubes) {
            ...
            cube.uniformBuffer.copy(cube.modelMat);
        }
    ...
    void OnUpdateUIOverlay() override {
        ...
        if (ui.header("Device properties")) {
            ui.text("maxPushDescriptors: %d", deviceInfo.properties.pushDescriptorsKHR.maxPushDescriptors);
        }
    }
};
