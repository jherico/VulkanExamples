...
public:
    ...
    void loadAssets() override {
        meshes.model.loadFromFile(getAssetPath() + "models/voyager/voyager.dae", meshes.vertexLayout);
    ...
    void setupDescriptorSet() {
        ...
        auto colorDesc = textures.colorMap.makeDescriptor(defaultSampler);
        std::vector<vk::WriteDescriptorSet> writeDescriptorSets{
            // Binding 0 : Vertex shader uniform buffer
            { descriptorSet, 0, 0, 1, vk::DescriptorType::eUniformBuffer, nullptr, &uniformData.vsScene.descriptor },
            // Binding 1 : Color map
            { descriptorSet, 1, 0, 1, vk::DescriptorType::eCombinedImageSampler, &colorDesc },
        };
