...
#include <shaders/radialblur/colorpass.frag.inl>
#include <shaders/radialblur/colorpass.vert.inl>
#include <shaders/radialblur/phongpass.frag.inl>
#include <shaders/radialblur/phongpass.vert.inl>
#include <shaders/radialblur/radialblur.frag.inl>
#include <shaders/radialblur/radialblur.vert.inl>
...
public:
    ...
    ~VulkanExample() {
        ...
        device.destroy(pipelines.radialBlur);
        device.destroy(pipelines.phongPass);
        device.destroy(pipelines.colorPass);
        device.destroy(pipelines.fullScreenOnly);

        device.destroy(pipelineLayouts.radialBlur);
    ...
    void loadMeshes() { meshes.example.loadFromFile(getAssetPath() + "models/glowsphere.dae", vertexLayout, 0.05f); }
...
#undef QUAD_COLOR_NORMAL
    ...
    void setupDescriptorSet() {
        ...
        vk::DescriptorImageInfo texDescriptor{ offscreen.sampler, offscreen.colorTargets[0].imageView, vk::ImageLayout::eReadOnlyOptimal };
    ...
    void preparePipelines() {
        vks::pipelines::GraphicsPipelineBuilder pipelineBuilder{ device, pipelineLayouts.radialBlur };
        ...
        // Load shaders
        pipelineBuilder.loadShader(vkx::shaders::radialblur::radialblur::vert, vk::ShaderStageFlagBits::eVertex);
        pipelineBuilder.loadShader(vkx::shaders::radialblur::radialblur::frag, vk::ShaderStageFlagBits::eFragment);
        ...
        pipelineBuilder.loadShader(vkx::shaders::radialblur::phongpass::vert, vk::ShaderStageFlagBits::eVertex);
        pipelineBuilder.loadShader(vkx::shaders::radialblur::phongpass::frag, vk::ShaderStageFlagBits::eFragment);
        ...
        pipelineBuilder.destroyShaderModules();
        pipelineBuilder.loadShader(vkx::shaders::radialblur::colorpass::vert, vk::ShaderStageFlagBits::eVertex);
        pipelineBuilder.loadShader(vkx::shaders::radialblur::colorpass::frag, vk::ShaderStageFlagBits::eFragment);
    ...
    void prepareUniformBuffers() {
        ...
        uniformData.vsQuad = loader.createUniformBuffer(uboVS);

        // Fullscreen quad fragment shader uniform buffer
        uniformData.fsQuad = loader.createUniformBuffer(uboVS);
