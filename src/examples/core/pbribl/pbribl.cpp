...
#include <shaders/pbribl/pbribl.frag.inl>
#include <shaders/pbribl/pbribl.vert.inl>
#include <shaders/pbribl/skybox.frag.inl>
#include <shaders/pbribl/skybox.vert.inl>
...
public:
    ...
    ~VulkanExample() {
        device.destroy(pipelines.skybox, nullptr);
        device.destroy(pipelines.pbr, nullptr);
...
#define SINGLE_ROW 1
    ...
    void loadAssets() override {
        textures.environmentCube.loadFromFile(getAssetPath() + "textures/hdr/pisa_cube.ktx", vF::eR16G16B16A16Sfloat);
        // Skybox
        ...
        for (size_t i = 0; i < modelCount; ++i) {
            ...
            model.loadFromFile(getAssetPath() + "models/" + file, vertexLayout, 0.05f * (file == "venus.fbx" ? 3.0f : 1.0f));
        }
    }
    ...
    void preparePipelines() {
        ...
        pipelineBuilder.loadShader(vkx::shaders::pbribl::skybox::vert, vSS::eVertex);
        pipelineBuilder.loadShader(vkx::shaders::pbribl::skybox::frag, vSS::eFragment);
        ...
        pipelineBuilder.loadShader(vkx::shaders::pbribl::pbribl::vert, vSS::eVertex);
        pipelineBuilder.loadShader(vkx::shaders::pbribl::pbribl::frag, vSS::eFragment);
    ...
    void prepare() override {
        ...
        vkx::pbr::generateIrradianceCube(textures.irradianceCube, models.skybox, vertexLayout, environmentDesc);
        vkx::pbr::generatePrefilteredCube(textures.prefilteredCube, models.skybox, vertexLayout, environmentDesc);
