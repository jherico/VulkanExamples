...
#include <shaders/pushconstants/lights.frag.inl>
#include <shaders/pushconstants/lights.vert.inl>
...
#undef cos_t
    ...
    void loadAssets() override { meshes.scene.loadFromFile(getAssetPath() + "models/samplescene.dae", vertexLayout, 0.35f); }
    ...
    void preparePipelines() {
        ...
        pipelineBuilder.loadShader(vkx::shaders::pushconstants::lights::vert, vk::ShaderStageFlagBits::eVertex);
        pipelineBuilder.loadShader(vkx::shaders::pushconstants::lights::frag, vk::ShaderStageFlagBits::eFragment);
